...
function C.extend_palette(options)
	...
	C.bg_selected = U.blend(C.bg, C.base4, 0.88) -- Background for selected items
	...
	-- Popups
	C.bg_popup = U.blend(C.bg, C.base8, 0.13) -- Popup background
	C.fg_popup = U.lighten(C.fg, 0.9, C.bg) -- Popup text
