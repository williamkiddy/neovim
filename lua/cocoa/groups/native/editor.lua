...
function M.get(colors, options)
	return {
		Comment = { fg = colors.fg_dark, italic = options.italic_comments },                         -- Comment text, italicized if configured
		...
		CursorColumn = { bg = U.blend(colors.bg_bright, colors.fg_visual, options.cursorline.blend) }, -- Cursor line background blended
		...
		CursorLineSign = { bg = colors.def2 },                                                       -- No specific color for cursor line signs
